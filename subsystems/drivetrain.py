...
class SwerveDrive():
    ...
    def __init__(self):
        ...
        self.s_widget = Shuffleboard.getTab("PID").add(f"S", 0.18).withSize(2, 2).getEntry()
        self.v_widget = Shuffleboard.getTab("PID").add(f"V", 0.13757366).withSize(2, 2).getEntry()
        self.a_widget = Shuffleboard.getTab("PID").add(f"A", 0.01267852).withSize(2, 2).getEntry()
        self.p_widget = Shuffleboard.getTab("PID").add(f"P", 0.11).withSize(2, 2).getEntry()
        ...
        self.acceleration_widget = Shuffleboard.getTab("PID").add(f"Acceleration", 100.0).withSize(2, 2).getEntry()
        self.jerk_widget = Shuffleboard.getTab("PID").add(f"Jerk", 1500.0).withSize(2, 2).getEntry()
